...
if(isset($_POST['submit']))
{
 ...
 {
     echo "<script type='text/javascript'>alert('Enter credit Greater than Zero');</script>";
 }
    else {
...
<nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="./index.php">Sparks</a>
            </div>
    ...
    <div class="container">
        ...
        <form method="post" name="tcredit"><br/>
            ...
            ?>
            <label style="color: #c06565"> credit
s Transfer From: </label><br/>
        ...
        <select class=" form-control" name="to" style="margin-bottom:5%;" required>
            ...
            <label style="color: #c06565">Enter Number of credit to be Transferred:</label>
